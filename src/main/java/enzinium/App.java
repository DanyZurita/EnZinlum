...
public class App {
    ...
    public static void main( String[] args )
    {
         ...
         * 
         * name() 
         * @return devuelve el nombre del token de forma human-readable (p.e., â€œUS Dollarsâ€?).
         * 
         * symbol()
         * @return el nombre del sÃ­mbolo del token de forma human-readable (p.e., â€œUSDâ€?).
         * 
         * totalSupply()
         ...
         * Muestra una lista de compradores con el nÃºmero de entradas
